...
# Para Vercel: função handler que será chamada pela Vercel
def handler(request):
    with app.app_context():
        return app.full_dispatch_request()

# Não será necessário rodar o Flask diretamente com `app.run(debug=True)` quando deployado na Vercel.
